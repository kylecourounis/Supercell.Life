            ...
            if (gamemode.Avatar.ExpLevel >= this.Hero.RequiredXpLevel)
            {
                ...
                if (cost.Length >= 7)
                {
                    ...
                    if (diamonds != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough diamonds. (Diamonds : {gamemode.Avatar.Diamonds}, Require : {diamonds})");
                            return;
                        }
                    }
                    ...
                    if (gold != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough gold. (Gold : {gamemode.Avatar.Gold}, Require : {gold})");
                            return;
                        }
                    }
                    ...
                    if (energy != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough energy. (Energy : {gamemode.Avatar.Energy}, Require : {energy}.");
                            return;
                        }
                    }
                    ...
                    if (orb1 != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough of orb1. (Orb1 : {gamemode.Avatar.Orb1}, Require : {orb1})");
                            return;
                        }
                    }
                    ...
                    if (orb2 != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough of orb2. (Orb2 : {gamemode.Avatar.Orb2}, Require : {orb2})");
                            return;
                        }
                    }
                    ...
                    if (orb4 != 0)
                    {
                        ...
                        {
                            Debugger.Error($"Unable to buy the hero. {gamemode.Avatar.Name} ({gamemode.Avatar}) does not have enough of orb4. (Orb4 : {gamemode.Avatar.Orb4}, Require : {orb4})");
                            return;
                        }
                    }
                }
